...
def is_fundamental(name: str):
    ...
    # Фундаментальные дисциплины — точные признаки
    fundamental_keywords = [
        # математика и анализ
        "математ", "анализ", "статистик", "вероятност", "исследование операций",
        "оптимизац", "теоретическая механика",

        # программирование
        "программирован", "python", "алгоритм", "структуры данных", "микроконтроллер",

        # системы и архитектура
        "архитектур", "операционн", "системн", "электротехн", "электроник",

        # сети и базы данных
        "сет", "network", "базы данных", "sql", "субд",
