...
Требования2:
1. Минимум 6-10 тем дисциплины
2. Минимум 3-5 лабораторных работ
3. Минимум 3 образовательные технологии
4. Литература не менее 5 источников
5. Не использовать общие слова типа "текст"
6. Все элементы должны быть конкретными и реалистичными
"""
